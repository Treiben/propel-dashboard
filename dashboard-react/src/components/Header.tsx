						...
						{user && onViewChange && (
							<nav className="hidden md:flex items-center gap-1">
								<button
									...
									className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${currentView === 'flags'
								...
								{isAdmin && (
									<button
										...
										className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${currentView === 'users'
												? 'bg-blue-100 text-blue-700'
												: 'text-gray-700 hover:bg-gray-100'
											}`}
									>
								...
								{user && onViewChange && (
									<>
										<button
											...
											className={`flex items-center gap-2 w-full text-left py-2 px-3 rounded-lg transition-colors ${currentView === 'flags'
										...
										{isAdmin && (
											<button
												...
												className={`flex items-center gap-2 w-full text-left py-2 px-3 rounded-lg transition-colors ${currentView === 'users'
														? 'bg-blue-100 text-blue-700 font-medium'
														: 'text-gray-700 hover:bg-gray-100'
													}`}
											>
							...
							<div className="space-y-4">
								<div>
									...
									<p className="text-gray-700 leading-relaxed">
										Propel Feature Flags is a feature management system built for .NET applications.
										This dashboard provides an interface to manage feature releases, control rollouts,
